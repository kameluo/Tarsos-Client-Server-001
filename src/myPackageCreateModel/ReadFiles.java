...
static ArrayList<float[]> arraylistCategory=new ArrayList<float[]>();
 
static ArrayList<ArrayList<float[]>> outer = new ArrayList<ArrayList<float[]>>();
...
dispatcher.addAudioProcessor(new AudioProcessor() {
       ...
       public void processingFinished() {
        ...
        arraylistCategory.add(arrayFinalAverage);
...
FileOutputStream outputStream=new FileOutputStream("mel coef excel sheet for audio files.xls");
...
public static void writeExcelSheet(String categoryName,Workbook workbook) throws IOException {
//Workbook workbook=new HSSFWorkbook();
