...
import examples.be.tarsos.dsp.example.Shared;
import jvm.be.tarsos.dsp.io.jvm.JVMAudioInputStream;
import core.be.tarsos.dsp.onsets.PercussionOnsetDetector;
import core.be.tarsos.dsp.onsets.PrintOnsetHandler;
