...
public class Sender {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String message="Hello How Are You? from the sender";
			
			DatagramPacket datagrampacket=new DatagramPacket(message.getBytes(),message.length(),group,3456);
		...
		try {
			...
			MulticastSocket multicastsocket=new MulticastSocket(3455);//opening a multicast socket port
