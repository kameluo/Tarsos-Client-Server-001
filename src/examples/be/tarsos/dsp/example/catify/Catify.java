...
package examples.be.tarsos.dsp.example.catify;
...
import core.be.tarsos.dsp.GainProcessor;
import core.be.tarsos.dsp.WaveformSimilarityBasedOverlapAdd;
import core.be.tarsos.dsp.WaveformSimilarityBasedOverlapAdd.Parameters;
import examples.be.tarsos.dsp.example.PitchShiftingExample;
import examples.be.tarsos.dsp.example.SharedCommandLineUtilities;
import jvm.be.tarsos.dsp.io.jvm.AudioDispatcherFactory;
import core.be.tarsos.dsp.resample.RateTransposer;
