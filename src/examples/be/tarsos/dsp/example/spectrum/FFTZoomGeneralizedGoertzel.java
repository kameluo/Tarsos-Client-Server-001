package examples.be.tarsos.dsp.example.spectrum;
...
import examples.be.tarsos.dsp.example.constantq.Player;
import examples.be.tarsos.dsp.example.constantq.Player.PlayerState;
...
import jvm.be.tarsos.dsp.ui.layers.LegendLayer;
import jvm.be.tarsos.dsp.ui.layers.MouseCursorLayer;
import jvm.be.tarsos.dsp.ui.layers.PitchContourLayer;
import jvm.be.tarsos.dsp.ui.layers.Scalogram;
import jvm.be.tarsos.dsp.ui.layers.SelectionLayer;
import jvm.be.tarsos.dsp.ui.layers.TimeAxisLayer;
import jvm.be.tarsos.dsp.ui.layers.TooltipLayer;
import jvm.be.tarsos.dsp.ui.layers.VerticalFrequencyAxisLayer;
import jvm.be.tarsos.dsp.ui.layers.WaveFormLayer;
