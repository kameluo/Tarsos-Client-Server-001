...
package examples.be.tarsos.dsp.example;

import javax.sound.sampled.AudioFormat;
import javax.sound.sampled.LineUnavailableException;

import core.be.tarsos.dsp.AudioGenerator;
import core.be.tarsos.dsp.effects.DelayEffect;
import core.be.tarsos.dsp.effects.FlangerEffect;
import core.be.tarsos.dsp.filters.LowPassFS;
import jvm.be.tarsos.dsp.io.jvm.AudioPlayer;
import core.be.tarsos.dsp.synthesis.AmplitudeLFO;
import core.be.tarsos.dsp.synthesis.NoiseGenerator;
import core.be.tarsos.dsp.synthesis.SineGenerator;
