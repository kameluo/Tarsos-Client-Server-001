...
package examples.be.tarsos.dsp.example.dissonance;
...
import core.be.tarsos.dsp.SpectralPeakProcessor;
import core.be.tarsos.dsp.SpectralPeakProcessor.SpectralPeak;
import examples.be.tarsos.dsp.example.dissonance.KernelDensityEstimate.GaussianKernel;
import examples.be.tarsos.dsp.example.dissonance.KernelDensityEstimate.Kernel;
import examples.be.tarsos.dsp.example.spectrum.SpectralInfo;
import core.be.tarsos.dsp.io.PipeDecoder;
...
import jvm.be.tarsos.dsp.ui.Axis;
import jvm.be.tarsos.dsp.ui.AxisUnit;
import jvm.be.tarsos.dsp.ui.CoordinateSystem;
import jvm.be.tarsos.dsp.ui.LinkedPanel;
import jvm.be.tarsos.dsp.ui.ViewPort;
import jvm.be.tarsos.dsp.ui.ViewPort.ViewPortChangedListener;
import jvm.be.tarsos.dsp.ui.layers.AmplitudeAxisLayer;
import jvm.be.tarsos.dsp.ui.layers.BackgroundLayer;
import jvm.be.tarsos.dsp.ui.layers.DragMouseListenerLayer;
import jvm.be.tarsos.dsp.ui.layers.HorizontalFrequencyAxisLayer;
import jvm.be.tarsos.dsp.ui.layers.Layer;
import jvm.be.tarsos.dsp.ui.layers.SelectionLayer;
import jvm.be.tarsos.dsp.ui.layers.SpectrumLayer;
import jvm.be.tarsos.dsp.ui.layers.ZoomMouseListenerLayer;
import jvm.be.tarsos.dsp.ui.layers.pch.ScaleLayer;
import core.be.tarsos.dsp.util.PitchConverter;
